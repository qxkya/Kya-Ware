...
CMDs[#CMDs + 1] = {NAME = 'destroy / destroyscript / ds', DESC = 'Unloads Infinite Yield'}
wait()
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		toClipboard('https://discord.com/invite/pcnB9cj64e')
		notify('Discord Invite', 'Copied to clipboard!\ndiscord.com/invite/pcnB9cj64e')
	else
		notify('Discord Invite', 'discord.com/invite/pcnB9cj64e')
	end
	if httprequest then
		httprequest({
...
addcmd('destroy',{'destroyscript','ds'},function(args, speaker)
